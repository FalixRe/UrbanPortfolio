...
let localizationTable = {
  en: {
    ...
    nokiaContent: '2018 - Now: Working as a software developer in LTE and 5G network development. Recently started part time work as a Scrum Master.',
    ...
    postgraduateContent: '2024: Postgraduate studies "Web Application Programming" on University of Science and Technology AGH in Cracow',
    ...
    coursesContent: 'SAFe practitioner, driver\'s license, skipper\'s license',
    skillsTitle: 'Skills',
    ...
    electronicsChannel: 'During college I was also very interested in microcontrollers programming and some of my projects can be seen on this YouTube channel:'
  },
  pl: {
    intro:'Wstęp',
    aboutMe:'O mnie',
    ...
    browserNotSupportVideo: 'Twoja przeglądarka nie wspiera wideo w kodzie HTML.',
    ...
    programmerContent: 'Aktualnie programuję w branży telekomunikacyjnej. Głównie w C++, ale mam styczność także z Java, lua, ttcn-3. Wcześniej pracowałem też w C na platformie AVR.',
    travellerContent: 'Urlopy spędzam głównie podróżując. Szczególnie lubię odwiedzać wyspy. Byłem już na większości z Wysp Kanaryjskich, Majorce, Bornholmie, Mauritiusie i paru innych żeglując na Chorwacji i w Grecji.',
    hobbistContent: 'Mam całkiem szerokie zainteresowania. Lubię uczyć się nowych rzeczy, dlatego skończyłem jako programista, pomimo iż ukończyłem mechatronikę. To także jeden z powodów, przez które stworzyłem tą stron. Aktualnie uczę się hiszpańskiego. Lubię także żeglować i prawie każdy rodzaj muzyki.',
    myCareer: 'Moja kariera',
    nokiaTitle: 'NOKIA - Inżynier oprogramowania',
    nokiaContent: '2018 - Teraz: Pracuję jako programista rozwijając i utrzymując sieć 5G i LTE. Niedawno zacząłem także cześciowo pełnić obowiązki Scrum Mastera.',
    ...
    postgraduateContent: '2024: Studia podyplomowe "Programowanie Aplikacji Webowych" na Akademii Górniczo-Hutniczej w Krakowie.',
    graduateContent: '2018: Dyplom magistra inżynierii mechatronicznej na Akademii Górniczo-Hutniczej w Krakowie.',
    coursesTitle: 'Kursy',
    coursesContent: 'SAFe practitioner, prawo jazdy, patent żeglarski',
    skillsTitle: 'Umiejętności',
    skillsContent: 'Dobre umiejętności pracy w zespole, umiejętności analityczne, dobrze radzę sobie z komputerami. Aktualnie najlepiej radzę sobie z C++, ale znam też podstawy C, Java, C#, Lua, TTCN-3, HTML, CSS, JS.',
  ...
  es: {
    ...
    nokiaContent: '2018 - Presente: Estoy trabajando como ingeniero de software en desarollo de 5G y LTE red. Acabo de empazar a trabajar en parte como ScrumMaster.',
    ...
    postgraduateContent: '2024: Estudios de postgrado "Programación de aplicaciones web" en la Universidad de Ciencia y Tecnología AGH en Cracovia',
